...
def detect_and_display(model, video_capture, face_detector, open_eyes_detector, left_eye_detector, right_eye_detector, data, eyes_detected):
    ...
    for (x,y,w,h) in faces:
        ...
        if isBlinking(eyes_detected[name],3):
            ...
            cv2.putText(frame, "Lizard AKA Non-human", (x, y), cv2.FONT_HERSHEY_SIMPLEX,0.75, (0, 255, 0), 2)
...
if __name__ == "__main__":
    ...
    #Get known members encodings and names from the database
    namesEncodingsPairs = getKnownEncodings()
